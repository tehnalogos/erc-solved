...
summary: "LSP6 sits in front of a Universal Profile (LSP0) and gates every call by a per-controller permission bitfield, allowed calls, and allowed ERC-725Y data keys."
purpose: Permission
updated: 2026-06-22
abi: |
