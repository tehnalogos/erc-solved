...
summary: "LSP7 is the LUKSO Digital Asset standard. It keeps ERC-20's balance model, then adds a force flag, a data payload, LSP1 receiver notifications, and amount-scoped operators with explicit events."
purpose: Token
updated: 2026-06-22
abi: |
