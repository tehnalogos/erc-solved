...
pageTitle: "Smart Account Permissions: Session Keys, Modules, EIP-7702, LSP6"
description: "How granular per-app, per-device, and per-function account permissions are expressed across the major chains — and the tradeoffs of each approach."
