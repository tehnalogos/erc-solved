...
pageTitle: "Onchain Identity: Account Models, Profiles, Attestations Compared"
description: "How dapps represent users on-chain — account-as-identity, name resolution, attestation primitives, and portable profiles — across Ethereum L1, the major L2s, Solana, and LUKSO."
