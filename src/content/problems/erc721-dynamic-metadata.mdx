...
description: "tokenURI returns a single URI per token. Dynamic NFTs need refresh logic, off-chain servers, and marketplace cooperation. Compare ERC-4906, fully onchain SVG, and LSP8 plus ERC-725Y key/value metadata."
erc: "721"
lsps: ["LSP8", "LSP4"]
