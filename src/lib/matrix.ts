...
export const matrixRows: MatrixRow[] = [
  ...
  },
  {
    ...
    verdict: 'bytes32 IDs, LSP4 metadata, ERC725Y per-token data',
  ...
  },
  {
    ...
    verdict: 'LSPs publish ERC165 interface IDs — no replacement needed',
  },
  {
    ercChip: 'ERC·725',
    ...
    verdict: 'the ERC725Y data store is the foundation of LSP metadata',
